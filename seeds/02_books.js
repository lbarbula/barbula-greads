  ...
  return knex.raw('TRUNCATE book RESTART IDENTITY CASCADE')
    ...
    .then(function(genres){
      return Promise.all([
        ...
        knex('book').insert(
          {book_name: 'Javascript In A Nutshell',
          genre_id: find.findGenre('Python', genres),
          ...
          knex('book').insert(
            ...
            knex('book').insert(
              {book_name: 'Learning React Native',
              genre_id: find.findGenre('JavaScript', genres),
              ...
              knex('book').insert(
                {book_name: "You Don't Know JS: ES6 & Beyond",
                genre_id: find.findGenre('JavaScript', genres),
                ...
                knex('book').insert(
                  ...
                  knex('book').insert(
                    {book_name: "You Don't Know JS: Async & Performance",
                    genre_id: find.findGenre('JavaScript', genres),
